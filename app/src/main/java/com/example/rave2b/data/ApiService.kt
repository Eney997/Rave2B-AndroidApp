...
interface ApiService {
    ...
    //delete transaction by username
    @DELETE("api/Transaction/deleteByUsername/{username}")
    suspend fun deleteTransaction(@Path("username") username: String): Response<Void>
}